...
export default function NimsPage() {
  return (
    <PageLayout title="마약류통합관리시스템(NIMS)">
      ...
      <h3 className={cn(textStyles.titleMd, 'mb-2')}>주요 기능</h3>
      <div className="space-y-4 mb-8">
        <Card variant="muted">
          <p className={cn(textStyles.titleSm, 'mb-1')}>[보고 시스템]</p>
          <p>
        ...
        <Card variant="muted">
          <p className={cn(textStyles.titleSm, 'mb-1')}>[실시간 모니터링]</p>
          <p>
        ...
        <Card variant="muted">
          <p className={cn(textStyles.titleSm, 'mb-1')}>[오남용 예방]</p>
          <p>
      ...
      <h3 className={cn(textStyles.titleMd, 'mb-2')}>이용 안내</h3>
