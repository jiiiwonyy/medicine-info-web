...
export default function AdverseReliefPage() {
  return (
    <PageLayout title="의약품 부작용 피해구제">
      <p className={cn(textStyles.titleLg, 'mb-6')}>
        부작용 피해구제 제도 안내
      </p>
      ...
      {/* 지원 대상 */}
      <h3 className={cn(textStyles.titleLg, 'mb-3')}>📌 지원 대상</h3>
      ...
      {/* 지원 범위 */}
      <h3 className={cn(textStyles.titleLg, 'mb-3')}>💰 지원 범위</h3>
      <ul className="list-disc pl-6 space-y-2">
        <li>
      ...
      {/* 신청 방법 */}
      <h3 className={cn(textStyles.titleLg, 'mb-3')}>📝 신청 방법 및 절차</h3>
      <p className="mb-4">
        부작용 피해구제 신청은{' '}
        <span className="font-semibold text-sky-900">
          의약품안전나라 전자민원/보고 메뉴
      ...
      <Card className="p-4 mb-4" variant="muted">
        <p className={cn(textStyles.titleSm, 'mb-2')}>📍 신청 경로</p>
