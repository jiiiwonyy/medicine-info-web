    ...
    <PageLayout title="의약품안전사용서비스(DUR)">
      <div className="space-y-12">
        ...
        <Callout variant="info" className="mb-8">
          <p className={cn(textStyles.body, 'text-fg leading-relaxed mb-4')}>
        ...
        <section className="space-y-4">
          <h3 className={textStyles.sectionTitle}>DUR 서비스 제공 방식</h3>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h4 className={cn(textStyles.sectionTitle, 'mt-4 text-lg')}>
                병용금기
              </h4>
              <p
                className={cn(
        ...
        {/* DUR 활용 사례 */}
        <section className="space-y-4">
          <h3 className={textStyles.sectionTitle}>DUR 활용 사례</h3>
        ...
        <section>
          <Card variant="primary" padding="lg" className="text-center">
            <h3 className={cn(textStyles.sectionTitle, 'text-2xl mb-4')}>
              DUR 활용의 의의
            </h3>
            <p className={cn(textStyles.body, 'text-muted-fg leading-relaxed')}>
            ...
            <div className="mt-6">
              <p className={cn(textStyles.body, 'font-medium text-xl')}>
